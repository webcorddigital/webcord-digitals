    ...
    <section id="cta">
      ...
      <div className="cta-inner reveal">
        ...
        <div className="cta-actions">
          <a href="mailto:hello@webcord.in" className="btn-inv">
            Email Us
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M1 6.5h11M6.5 1l5.5 5.5-5.5 5.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </a>
          <a href="https://wa.me/91XXXXXXXXXX" className="btn-whatsapp" target="_blank" rel="noopener">
    ...
    <section id="contact">
      <div className="contact-grid">
        <div className="contact-item">
          ...
          <a href="https://wa.me/91XXXXXXXXXX" className="contact-value" target="_blank" rel="noopener noreferrer">+91 XXXXX XXXXX</a>
        </div>
        <div className="contact-item">
          <span className="contact-label">Email</span>
          <a href="mailto:hello@webcord.in" className="contact-value">hello@webcord.in</a>
        </div>
        <div className="contact-item">
          <span className="contact-label">Website</span>
          <a href="https://webcord.in" className="contact-value" target="_blank" rel="noopener noreferrer">webcord.in</a>
        </div>
        <div className="contact-item">
          <span className="contact-label">Location</span>
          <span className="contact-value">Phagwara, Punjab, India</span>
        </div>
      </div>
    </section>
  );
    ...
    <footer>
      <div className="footer-top">
        <div className="footer-brand">
          <Link href="/" className="footer-brand-logo"><span className="nav-dot"></span>WEBCORD</Link>
        ...
        <div className="footer-col">
          <h6>Contact</h6>
          <ul>
            <li><a href="mailto:hello@webcord.in">hello@webcord.in</a></li>
            <li><a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer">WhatsApp Us</a></li>
            <li><a href="https://webcord.in" target="_blank" rel="noopener noreferrer">webcord.in</a></li>
            <li><a href="#">Phagwara, Punjab, India</a></li>
          </ul>
        </div>
      </div>
